...
CONFIG = {
    ...
    'DETECTION_INTERVAL': 0.8,  # Intervalo entre detecciones en segundos (1.0: equilibrado, 0.5: más frecuente)
    ...
    'FRAME_SUBSAMPLE': 1.0,  # Procesar cada N frames (1: todos, 2: cada segundo frame)
                           # Opciones: 1, 2, 3
    'STABILITY_THRESHOLD': 3,  # Detecciones consecutivas para confirmar una pieza (3: estable, 2: más rápido)
                               # Opciones: 2, 3, 4
}
